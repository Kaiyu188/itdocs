						...
						<form method="post" enctype="multipart/form-data">
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										<label>Miêu tả</label>
										{{--  Để src script trên head
										<script src="https://cdn.tiny.cloud/1/ort9geiqy6wua9wcvb6q9fk95ezn6y82evof4hpgnxyxwat4/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>  --}}

										{{--  sua selector theo ID textarea sau # trong tinymce.init  --}}
										<textarea id="full-featured-non-premium"required name="content"></textarea>
